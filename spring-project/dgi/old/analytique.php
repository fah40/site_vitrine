...
<?php
    ...
    $directory = "./documents/analytique"; // Remplacez par le chemin de votre dossier
                        ...
                        <div class="container fah-hero-main fah-relative fah-aic">
                            <div class="fah-hero-text fah-scale-img" data-value-1="1.3" data-value-2="0.95" style="translate: none; rotate: none; scale: none; transform: translate3d(0px, 0px, 0px) scale(0.9864, 0.9864);">
                                ...
                                <div class="fah-word-frame">
                                    <h1 class="fah-head1 fah-mb60 fah-rubber"><span class="fah-up">Analytiques fiscales</span></h1>
                            ...
                            <div class="row fah-jcc">
                                <div class="col-sm-4 col-lg-4">
                                    <div class="fah-iconbox fah-tac fah-mb60">
                                        ...
                                        <p class="fah-text-md fah-up" style="translate: none; rotate: none; scale: none; transform: translate(0px, 0px); opacity: 1; text-align:right;">Consultez dans cette rubrique les documents d'analyse approfondis retraçant ses performances en matière de mobilisation des recettes fiscales, statistiques périodiques des réalisations, études sectorielles, publications économiques, rapports détaillés d’activités, etc.</p>
                                    </div>
                                </div>
